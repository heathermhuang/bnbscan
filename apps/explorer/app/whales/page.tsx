              ...
              return (
                <tr key={w.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-2 font-mono text-xs">
                    <Link href={`/tx/${w.txHash}`} className={`${chainConfig.theme.linkText} hover:underline`}>
                      {w.txHash.slice(0, 14)}…
                    </Link>
                  </td>
                  <td className="px-4 py-2">
                    <Link href={`/token/${w.tokenAddress}`} className={`${chainConfig.theme.linkText} hover:underline font-medium`}>
