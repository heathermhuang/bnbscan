...
export function NetworkSwitcher({ direction = 'down' }: { direction?: 'down' | 'up' }) {
  ...
  // Chevron points up when open (down direction) or down when open (up direction)
  ...
  return (
    <div ref={ref} className="relative shrink-0">
      ...
      >
        ...
        {current.short}
        <svg
          className={`w-3 h-3 text-white/70 transition-transform duration-150 ${chevronOpen ? 'rotate-180' : ''}`}
