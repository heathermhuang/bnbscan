...
export default function VerifyPage() {
  ...
  const statusStyles: Record<Status, string> = {
    idle:    '',
    loading: 'bg-indigo-50 text-indigo-700 border border-indigo-200',
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <p className="text-gray-500 mb-8">
        ...
        <a href="https://sourcify.dev" className="text-indigo-600 hover:underline" target="_blank" rel="noreferrer">
          Sourcify
        </a>{' '}
        for existing verifications on Ethereum Mainnet (chain ID 1).
      </p>
