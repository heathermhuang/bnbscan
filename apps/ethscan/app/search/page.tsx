                  ...
                  {tokenMatches.map(token => (
                    <tr key={token.address} className="hover:bg-gray-50">
                      <td className="px-4 py-2 font-medium">
                        <Link href={`/token/${token.address}`} className="text-indigo-600 hover:underline">
                          {token.name}
                        </Link>
                      </td>
                      <td className="px-4 py-2 text-gray-700">{token.symbol}</td>
                      <td className="px-4 py-2 text-gray-500">ERC-20</td>
