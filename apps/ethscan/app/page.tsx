...
function SectionHeader({ title, href }: { title: string; href: string }) {
  return (
    <div className="flex justify-between items-center mb-3">
      ...
      <Link href={href} className="text-sm text-indigo-600 hover:underline">View all →</Link>
    </div>
  )
}
