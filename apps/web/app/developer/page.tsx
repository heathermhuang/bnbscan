    ...
    <div className="max-w-5xl mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 text-lg">
          Build on BNB Chain with BNBScan&apos;s REST API, webhooks, and flexible query interface.
        </p>
      </div>
...
curl "https://bnbscan.io/api/v1/keys?owner=0xYourAddress"`}</pre>
      ...
      <section id="webhooks" className="mb-10">
        <div className="bg-white rounded-xl border shadow-sm overflow-hidden">
          ...
          <div className="px-6 py-5 space-y-4">
            <p className="text-gray-700">
              Subscribe to real-time on-chain events. BNBScan will POST to your URL whenever the specified
  ...
  -d '{
    ...
    "limit": 100
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6 text-center">
        ...
        <p className="text-gray-600 mb-4">Get your API key and start querying the BNB Chain in minutes.</p>
        <a
          href="/api-docs"
